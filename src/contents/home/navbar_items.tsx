...
export const NavbarItems = () => {
  return (
    <>
      <div className="absolute bottom-0 flex w-[95%] items-center justify-between rounded-2xl border border-[#27262C]/40 bg-[#18181D]/60 p-4 shadow-md backdrop-blur-md dark:border-[#5E5E5E]/40 laptop:hidden">
      ...
      <div className="fixed top-0 my-2 hidden h-16 items-center justify-center rounded-2xl border border-white/25 px-12 py-4 backdrop-blur-md dark:border-[#5E5E5E]/40 dark:bg-[#18181D]/30 laptop:flex">
        <ul className="flex gap-12">
          ...
          <RxDividerVertical
            size={24}
            className="text-onyx/50 dark:text-white"
          />
          <ThemeSwitch className="dark:text-white" />
        </ul>
      </div>
    </>
  );
